...
public interface IMessageBuffer<T> {
	 ...
	 *         empty.
	 */
	<V> V readObject(ITransform<T, V> converter);

	IMessageBuffer<T> writeByte(byte b);
	 ...
	 */
	IMessageBuffer<T> writeBytes(byte[] src);
	 ...
	 */
	IMessageBuffer<T> writeShort(int value);
	 ...
	 */
	IMessageBuffer<T> writeMedium(int value);
	 ...
	 */
	IMessageBuffer<T> writeInt(int value);
	 ...
	 */
	IMessageBuffer<T> writeLong(long value);
	 ...
	 *             if {@code this.writableBytes} is less than {@code 2}
	 */
	IMessageBuffer<T> writeChar(int value);
	 ...
	 *             if {@code this.writableBytes} is less than {@code 4}
	 */
	IMessageBuffer<T> writeFloat(float value);
	 ...
	 *             if {@code this.writableBytes} is less than {@code 8}
	 */
	IMessageBuffer<T> writeDouble(double value);

	IMessageBuffer<T> writeString(String message);

	IMessageBuffer<T> writeStrings(String... message);
	 ...
	 */
	<V> IMessageBuffer<T> writeObject(ITransform<V, T> converter, V object);
