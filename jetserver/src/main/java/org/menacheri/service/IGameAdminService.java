...
public interface IGameAdminService
{
	 ...
	 * resources, {@link IGameRoom}s or {@link IPlayerSession}s associated
	 * with this game.
	 * 
	 * @param gameId
	 *            The unique number identifier for the game. Most probably a
	 ...
	 * will be the closing of any resources, {@link IGameRoom}s or
	 * {@link IPlayerSession}s associated with this game.
	 * 
	 * @param game
	 ...
	 * {@link IPlayerSession}s associated with this game room.
	 * 
	 * @param gameRoom
	 ...
	 * like {@link IPlayerSession}s associated with this game room.
	 * 
	 * @param game
	 *            The instance of the game for which the game room needs to be
	 *            removed
	 ...
	 *         boolean suggesting success(true) or failure(false).
	 */
	public Object unloadGameRoom(IGame game, String gameRoomName);
